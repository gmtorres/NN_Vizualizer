...
const InfoBasic = () => {
    ...
    return (
        <div>
            ...
            <br/>
            <br/>
            A Neural Networks can be consisted of several layer of different number of neurons. Neurons are connected by edges and each edge
            has a weight associated, which represent how much the value of the origin neuron influences the value in the end neuron. This
            ...
            <br/>
            <br/>
            Neural Networks are mainly used in supervised learning tasks, where we give the input and the correspondent output and our model
            ...
            This behaviour arise throught the complex interactions between the previous nodes and edges.
            <br/>
            <br/>
            ...
            <br/>We will step into more details in a next section.
            <br/>
            <br/>
            </p>
        </div>
